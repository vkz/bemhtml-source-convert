...
function toBh(ast) {
    return serializer.match(ast, 'topLevel', undefined, reportError);
}
...
function reportError(err) {
    ...
    err.message = ['Can\'t auto-convert this bemhtml because:']
        .concat(
            err.report.map(function (problem) { return ' * ' + problem; }))
        .join('\n') +
        '\n\n';
