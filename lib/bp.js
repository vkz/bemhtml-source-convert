var Blueprint = exports,
    ...
    ibem = require('fs').readFileSync(__dirname + '/../bower_components/bem-core/common.blocks/i-bem/i-bem.bemhtml', 'utf8'),
...
Blueprint.addPrettyPrinter = function addPrettyPrinter(obj, def) {
    obj.pp = function(what, options) {
        return prettyPrint(what || def, options);
    };
};
...
Bh.prototype = {
    ...
    match: function(json) {
        var bh = new BH().enableInfiniteLoopDetection(true),
