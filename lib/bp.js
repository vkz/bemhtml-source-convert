...
function prettyPrint(obj, opts) {
    ...
    msg = prompt + '\n' + wrappedObj + '\n';
    return asString ? msg : console.log(prefix, msg, postfix, '\n') && null;
}

Blueprint.pp = function (options) { return prettyPrint(this, options);};
Blueprint.prettyPrint = prettyPrint;
...
Classes.prototype = Object.create(lo.merge(Blueprint, bpClasses));
...
Bh.prototype.pp = function(options) {return prettyPrint(this.src, options);};
...
Bemhtml.prototype.pp = function(options) {return prettyPrint(this.src, options);};
